...
class AutoSets:
    ...
    TODO: this looks deprecated. It is only implemented for lyapunov. It looks never used in practice.
    """
...
def get_certificate(
    ...
    if certificate == CertificateType.LYAPUNOV:
        ...
        from fossil.cbf_certificate import ControlBarrierFunction
